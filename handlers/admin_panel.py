    ...
    if current_index + 1 < total:
        ...
        if submissions:
            ...
            if update.callback_query:
                await update.safe_edit_message(callback_query, 
                    review_text,
                    reply_markup=keyboard_gen.admin_panel_keyboard(),
                    parse_mode="Markdown"
                )
        ...
        if update.callback_query:
            await update.safe_edit_message(callback_query, msg)
...
"""
    ...
    await safe_edit_message(query, dashboard, parse_mode="Markdown")
...
async def show_subscribers_list(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not subs:
        await safe_edit_message(query, "No active subscribers yet! 🤔")
        return
...
"""
    ...
    await safe_edit_message(query, subs_text, parse_mode="Markdown")
...
"""
    ...
    await safe_edit_message(query, comm_text, parse_mode="Markdown")
...
"""
    ...
    await safe_edit_message(query, analytics_text, parse_mode="Markdown")
