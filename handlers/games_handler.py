...
async def show_games_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await safe_edit_message(query, text, reply_markup=_games_menu_keyboard(), parse_mode="Markdown")
...
async def start_trivia(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await flow_state.sync(context, update.effective_user.id, 0, flow="games")
