...
"""
    ...
    def format_clone_info() -> str:
        ...
        info = f"""
{EMOJI_COLORS['clone']} **Clone This Bot — 50 GHS**

Your own bot with the same anime/group-tools/utilities features, custom name & branding, and its own admin panel. Independent from this bot, ready to use.
"""
        return info.strip()
